...
namespace diskann {
  struct QueryStats {
    ...
    // Block utilization stats (for block-aware search)
    double n_block_vertices_scored = 0.0;  // # of vertices whose distance was computed
    double avg_vertices_per_block = 0.0;   // average vertices scored per block
  };
